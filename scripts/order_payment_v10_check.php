...
$checks = [
    ...
    'backoffice middleware' => ['app/Http/Middleware/BackofficeMiddleware.php', 'order_manager'],
    ...
    'admin orders view' => ['resources/views/admin/orders/show.blade.php', 'المراجعة التفصيلية'],
