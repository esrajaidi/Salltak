...
unset($__errorArgs, $__bag); ?>" type="password" name="password" autocomplete="current-password" required></div>
                ...
                <div class="text-center small text-secondary mt-4">ليس لديك حساب؟ <a class="fw-bold text-decoration-none text-primary" href="<?php echo e(route('register')); ?>">أنشئ حسابًا جديدًا</a></div>
            </div>
        </div>
    </div>
</section>
