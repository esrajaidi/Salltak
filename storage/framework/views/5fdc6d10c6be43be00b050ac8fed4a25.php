...
<section class="auth-page">
    <div class="container">
        <div class="surface-card-elevated auth-card">
            ...
            <p class="text-secondary mb-4">حساب واحد لحفظ سلاتك ومراجعة السعر الأصلي وسعره بالدينار.</p>
...
unset($__errorArgs, $__bag); ?>" name="phone" value="<?php echo e(old('phone')); ?>" autocomplete="tel" placeholder="09xxxxxxxx"></div>
            ...
            <div class="text-center small text-secondary mt-4">عندك حساب؟ <a class="fw-bold text-decoration-none" href="<?php echo e(route('login')); ?>">سجّل الدخول</a></div>
        </div>
    </div>
</section>
