...
<head>
    ...
    <title><?php echo $__env->yieldContent('title', 'سلات ليبيا'); ?></title>
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            ...
            <div class="d-flex flex-column flex-lg-row align-items-lg-center gap-2 me-lg-auto pt-2 pt-lg-0">
                ...
                <?php else: ?>
                    <a class="btn btn-link text-white text-decoration-none" href="<?php echo e(route('login')); ?>">تسجيل الدخول</a>
                    <a class="btn btn-light btn-sm px-3" href="<?php echo e(route('register')); ?>">إنشاء حساب</a>
                <?php endif; ?>
            </div>
        </div>
    </div>
