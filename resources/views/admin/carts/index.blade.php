...
<div class="mb-4"><div class="small text-primary fw-bold mb-1">إدارة البيانات</div><h1 class="page-heading">إدارة السلات</h1><p class="page-subtitle">ابحث وفلتر جميع السلات المحفوظة في المنصة.</p></div>
