    ...
    <div class="container">
        <div class="auth-shell reveal is-visible">
            <aside class="auth-side">
                ...
                <h2 class="h2">سلتك العالمية، مرتبة وسعرها واضح.</h2>
                <p>ادخلي لحسابك وارجعي لكل السلات المحفوظة، وراجعي الأسعار بالدولار والدينار وكمّلي من وين وقفتي.</p>
                <div class="auth-benefit"><i><x-icon name="check" size="18" /></i><span>سلاتك محفوظة في حسابك</span></div>
                <div class="auth-benefit"><i><x-icon name="exchange" size="18" /></i><span>السعر بالدولار والدينار</span></div>
                <div class="auth-benefit"><i><x-icon name="box" size="18" /></i><span>مقاس ولون وصورة المنتج</span></div>
            </aside>
            <div class="auth-card">
                <div class="d-flex align-items-center gap-3 mb-4"><div class="auth-brand-icon">س</div><div><div class="small text-primary fw-bold">سلتك</div><h1 class="h3 fw-bold mb-0 mt-1">مرحبًا بعودتك</h1></div></div>
                ...
                <form method="POST" action="{{ route('login.store') }}">@csrf
                    ...
                    <button class="btn btn-primary btn-lg w-100 icon-text-btn" type="submit"><x-icon name="check" size="18" /> تسجيل الدخول</button>
                </form>
