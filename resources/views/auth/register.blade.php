    ...
    <div class="container">
        <div class="auth-shell reveal is-visible">
            <aside class="auth-side">
                ...
                <h2 class="h2">ابدئي أول سلة في دقائق.</h2>
                <p>حساب واحد يجمع روابط السلات، تفاصيل المنتجات، المقاسات والألوان والتحويل للدينار.</p>
                <div class="auth-benefit"><i><x-icon name="carts" size="18" /></i><span>ألصقي رابط مشاركة SHEIN</span></div>
                <div class="auth-benefit"><i><x-icon name="eye" size="18" /></i><span>راجعي المنتجات الحقيقية</span></div>
                <div class="auth-benefit"><i><x-icon name="check" size="18" /></i><span>احفظي السلة وارجعي لها</span></div>
            </aside>
            <div class="auth-card">
                <div class="d-flex align-items-center gap-3 mb-4"><div class="auth-brand-icon">س</div><div><div class="small text-primary fw-bold">سلتك</div><h1 class="h3 fw-bold mb-0 mt-1">إنشاء حساب</h1></div></div>
                <p class="text-secondary mb-4">حسابك يخليك تحفظي سلاتك وتشوفي سعر الدولار والدينار جنب بعض.</p>
                <form method="POST" action="{{ route('register.store') }}">@csrf
                    ...
                    <button class="btn btn-primary btn-lg w-100 mt-4 icon-text-btn" type="submit"><x-icon name="plus" size="18" /> إنشاء الحساب</button>
                </form>
